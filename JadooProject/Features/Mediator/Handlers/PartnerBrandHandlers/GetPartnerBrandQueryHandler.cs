...
{
    public class GetPartnerBrandQueryHandler : IRequestHandler<GetPartnerBrandQuery, List<GetPartnerBrandQueryResult>>
    {
        private readonly JadooContext _context;

        public GetPartnerBrandQueryHandler(JadooContext context)
        {
            _context = context;
        }
